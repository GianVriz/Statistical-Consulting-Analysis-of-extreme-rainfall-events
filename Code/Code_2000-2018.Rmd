...
model_xgb = xgb.train(data = xgb_train,nthread = 2, eta = 0.32, max.depth = 7, nrounds = 1000, watchlist = watchlist, objective = "reg:squarederror", early_stopping_rounds = 50,  verbose = 1)
